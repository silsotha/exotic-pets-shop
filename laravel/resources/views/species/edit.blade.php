        ...
        <form method="POST" action="{{ route('admin.species.update', $species) }}">
            ...
            <div class="mb-3">
                ...
                <select id="care_level" name="care_level" class="form-select @error('care_level') is-invalid @enderror">
                    ...
                    <option value="beginner" {{ old('care_level', $species->care_level) === 'beginner' ? 'selected' : '' }}>
                        Подходит новичкам
                    </option>

                    <option value="intermediate" {{ old('care_level', $species->care_level) === 'intermediate' ? 'selected' : '' }}>
                        Средняя сложность
                    </option>

                    <option value="advanced" {{ old('care_level', $species->care_level) === 'advanced' ? 'selected' : '' }}>
